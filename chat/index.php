...
<head>
    ...
    <title>再续天庭存档编辑器在线留言</title>
    <link type="text/css" href="app/style/chat.css" rel="stylesheet" />
</head>
<body>
<div class="top"><span class="name">再续天庭存档编辑器在线留言</span>-<a href="javascript:;" onclick="skin()">点击换肤</a></div>
...
<div class="foot">&copy;<a target="_blank" href="../">返回首页</a>~再续天庭存档编辑器在线留言！<a href="javascript:location.reload()">刷新</a>-<a id="update" href="javascript:;">提示</a><script language="javascript" type="text/javascript" src="https://js.users.51.la/20891993.js"></script></div>
